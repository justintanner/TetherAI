...
KIE media provider for video and image generation (Kling 3.0, Grok Imagine, Nano Banana Pro).

## Installation

```bash
npm install @tetherai/kie-media
# or
pnpm add @tetherai/kie-media
```
...
```typescript
import { kieMedia } from "@tetherai/kie-media";

const provider = kieMedia({
...
Creates a KIE media provider instance.
